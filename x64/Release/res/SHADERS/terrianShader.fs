...
void main()
{
    ...
    vec3 c1 = vec3(0.0235, 0.5804, 0.0235);
    ...
    //MaterialDiffuseColor =  mix(c2,c1,(position0.y)/70.0);
    //MaterialDiffuseColor += vec3(0,1,0) * noise(Position_worldspace.xz*0.001) *0.1;
