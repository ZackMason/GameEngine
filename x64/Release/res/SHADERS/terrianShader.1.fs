...
void main()
{
    ...
    //MaterialDiffuseColor = mix(mix(c4,c3,(position0.y-35)/700.0), mix(c1,c2,(position0.y+35)/700.0),position0.y/700.0);
    ...
    else if(position0.y<150)
    {
        MaterialDiffuseColor=c4*.7;
    }
    else if(position0.y<170)
    {
        MaterialDiffuseColor = c4;
    }
    else if(position0.y<180)
    {
        MaterialDiffuseColor=c3;
    }
    else if(position0.y<190)
    {
        MaterialDiffuseColor=c3*.7;
    }
    else if(position0.y<250)
    {
        MaterialDiffuseColor=mix(c1,c2,(noise(Position_worldspace.xz)*.4));
    }
    else if(position0.y<300)
    {
        MaterialDiffuseColor=c1*.6+(noise(Position_worldspace.xz)*.1);
    }
    else if(position0.y<450)
    {
        MaterialDiffuseColor=c1*.4+(noise(Position_worldspace.xz)*.1);
    }
    else
    {
