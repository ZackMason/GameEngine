...
void main()
{
    ...
    {
        pos.y += noise(vec2(Position_worldspace.x/(xz_scale * pow(lacunarity,i)),
        Position_worldspace.z/(xz_scale * pow(lacunarity,i)))) * y_scale * pow(persistence,i);
    }
#if 0
    ...
    {
        pos.y=155;
        pos.y+=calcWave(Position_worldspace.x*0.03)*3;
        pos.y+=calcWave(Position_worldspace.z*0.03)*3;
    }
